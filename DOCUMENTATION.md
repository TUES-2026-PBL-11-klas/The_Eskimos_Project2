...
5. Екранни снимки (или ако е хардуер, снимки на проекта в действие)
6. AI Инструменти 
    Claude - reasearch
    Claude code - генериране на бойлерплейтове, дебъгване, писане на документация

Заключение - резултат, научено, бъдещо развитие
Източници (спазвайки глобален стандарт - пр. APA7; Harvard; etc.)
...
Приложения (link към хранилищата)
